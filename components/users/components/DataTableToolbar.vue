...
function triggerCreateUserAvatarFileInput() {
  createUserAvatarFileInput.value?.click()
}

function handleCreateUserImageFileChange(event: Event) {
...
function clearCreateUserAvatarChange() {
  if (createUserImagePreviewUrl.value && createUserImagePreviewUrl.value.startsWith('blob:')) {
    URL.revokeObjectURL(createUserImagePreviewUrl.value)
  }
        ...
        <Dialog v-model:open="isNewRoleDialogOpen">
          <DialogContent class="rounded-lg shadow-xl sm:max-w-[480px]">
            ...
            <div
              ...
              class="my-3 border border-red-300 rounded-md bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-700 dark:bg-red-900/30 dark:text-red-400"
            >
            ...
            <form @submit.prevent="handleCreateRole">
              <div class="grid gap-4 px-1 py-4">
                ...
                <div class="grid grid-cols-4 items-start gap-4">
                  <Label
                    ...
                    class="col-span-1 pt-1 text-right text-sm text-gray-700 font-medium dark:text-gray-300"
                  >
                    Description
                  </Label>
                  <Textarea
              ...
              <DialogFooter
                class="mt-2 border-t border-gray-200 rounded-b-lg bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse dark:border-slate-700 dark:bg-slate-800"
              >
        ...
        <Dialog v-model:open="isCreateUserDialogOpen">
          ...
          <DialogContent class="rounded-lg shadow-xl md:max-w-4xl sm:max-w-3xl">
            ...
            <div
              ...
              class="m-6 border border-red-300 rounded-md bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-700 dark:bg-red-900/30 dark:text-red-400"
            >
            ...
            <div class="max-h-[70vh] overflow-y-auto p-6">
              <div class="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-3">
                ...
                <div class="md:col-span-2 space-y-4">
                  <div>
                    <Label for="createUserName" class="mb-1 block text-sm font-medium">Name <span class="text-red-500">*</span></Label>
                    <Input
                      id="createUserName"
                  ...
                  <div>
                    <Label for="createUserUsername" class="mb-1 block text-sm font-medium">Username <span class="text-red-500">*</span></Label>
                    <Input
                  ...
                  <div>
                    <Label for="createUserEmail" class="mb-1 block text-sm font-medium">Email</Label>
                    <Input
                      id="createUserEmail"
                  ...
                  <div>
                    <Label for="createUserRole" class="mb-1 block text-sm font-medium">Role <span class="text-red-500">*</span></Label>
                    <div
                      v-if="isLoadingCreateUserRoles"
                      class="pt-2 text-sm text-gray-500 dark:text-gray-400"
                    >
                      Loading roles...
                    </div>
                    <Select
              ...
              <div class="mt-6 border-t border-gray-200 pt-6 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                  <div>
                    <Label for="createUserPassword" class="mb-1 block text-sm font-medium">Password
                      <span class="text-xs text-gray-500 font-normal">(Min. 6 chars)</span></Label>
                    <Input
                  ...
                  <div>
                    <Label for="createUserConfirmPassword" class="mb-1 block text-sm font-medium">Confirm Password</Label>
                    <Input
            ...
            <DialogFooter
              class="border-t border-gray-200 rounded-b-lg bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse dark:border-slate-700 dark:bg-slate-800"
            >
              <Button
                type="button"
                :disabled="
